...
export default function Chatbot({
  ...
  return (
    <Card className="h-[79vh] w-full border-2 border-zinc-200">
      <CardHeader>
        <CardTitle className="font-cal tracking-normal">
          {name || "Polymath Chatbot"}
        </CardTitle>
        <CardDescription className="leading-3">
          Powered by <span className="font-medium text-black">Polymath AI</span>
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div
        ...
        >
          {chats.map((chat, index) => (
            ...
            >
              ...
              <div className="leading-relaxed">
                ...
                <div className="mt-1 rounded-lg bg-zinc-200 px-4 py-1.5 font-medium text-black">
                  {chat.message}
                </div>
              </div>
            </div>
          ...
          {isLoading && (
            <div className="inline-block rounded-lg bg-black p-2 px-2.5">
              <Grid
                height={15}
                width={15}
                radius={10}
