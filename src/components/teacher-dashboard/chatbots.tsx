...
import { ChatbotCard } from "@/components/teacher-dashboard/chatbot-card"
...
const Chatbots = () => {
  ...
  return (
    <div className="self-center text-center ">
      ...
      {chatbots.length === 0 && (
        <div className="mt-3 flex flex-col items-center justify-center rounded-lg bg-zinc-200/60 pb-4">
          <Image
            alt="web-design svg"
            src="/create.svg"
            height={200}
